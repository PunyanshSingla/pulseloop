    ...
    return (
      <div className="flex flex-1 items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <h3 className="font-semibold text-lg text-foreground">Failed to load polls</h3>
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-xl md:text-2xl font-black tracking-tight">Polls</h1>
          <p className="text-sm text-muted-foreground font-medium">Manage and track your active and past polls.</p>
        </div>
