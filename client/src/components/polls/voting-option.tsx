...
export const VotingOption = ({
  ...
  return (
    <motion.button
      ...
      disabled={disabled}
      className={cn(
        "relative w-full flex items-center justify-between p-5 rounded-xl border-2 transition-all duration-500 text-left overflow-hidden group",
        isSelected
    ...
    >
      <div className="flex items-center gap-4 z-10">
        <div
          className={cn(
            "flex items-center justify-center size-6 rounded-lg border-2 transition-all duration-500",
            isSelected
